...
def get_running_containers():
    ...
    try:
        ...
        raise e(f"Error occurred while checking running containers: {e.stderr}")
...
def start_docker_desktop():
    ...
    try:
        ...
        raise e(f"Error starting Docker Desktop: {e.stderr}")
...
def start_docker_services():
    ...
    for command in commands:
        try:
            ...
            raise e(f"Error occurred while executing '{command}': {e.stderr}")
        except FileNotFoundError as e:
            raise e(f"Command not found or not executable: '{command}'")
